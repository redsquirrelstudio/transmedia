...
class FillPermissionsForFeaturedProject extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForFeaturedProject constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.featured-project',
            'admin.featured-project.index',
            'admin.featured-project.create',
            'admin.featured-project.show',
            'admin.featured-project.edit',
            'admin.featured-project.delete',
            'admin.featured-project.bulk-delete',
        ]);
